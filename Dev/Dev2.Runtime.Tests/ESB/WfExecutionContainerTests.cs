...
namespace Dev2.Tests.Runtime.ESB
{
    ...
    public class WfExecutionContainerTests
    {
        ...
        public void WfExecutionContainerExecuteInvokesWorkflowHelperCompileExpressions()
        {
            ...
            wh.Setup(h => h.CompileExpressions(It.IsAny<DynamicActivity>(),It.IsAny<Guid>())).Verifiable();
            ...
            wh.Verify(h => h.CompileExpressions(It.IsAny<DynamicActivity>(),It.IsAny<Guid>()));
        }
