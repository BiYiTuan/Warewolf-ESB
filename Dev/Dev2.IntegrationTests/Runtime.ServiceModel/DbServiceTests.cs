...
namespace Dev2.Integration.Tests.Runtime.ServiceModel
{
    ...
    public class DbServiceTests
    {
        ...
        {
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/Bug9139");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverURI, "Acceptance Testing Resources/Bug9490");
        ...
        {
            //------------Setup for test--------------------------
            string postData = String.Format("{0}{1}", _webserverURI, "Acceptance Testing Resources/Bug 10475 Outer WF");
        ...
        {
            //------------Setup for test--------------------------
            string postData = String.Format("{0}{1}", _webserverURI, "Acceptance Testing Resources/DB Service With No Output");
        ...
        public void DatabaseService_CanMapToMultipleRecordsets_WhenStraightFromDBService_ExpectPass()
        {
            ...
            //------------Setup for test--------------------------
            string postData = String.Format("{0}{1}", _webserverURI, "Acceptance Testing Resources/Service Output To Multiple Recordsets");
            const string expected = @"<result>PASS</result>";
        ...
        {
            //------------Setup for test--------------------------
            var postData = String.Format("{0}{1}", _webserverURI, "Acceptance Testing Resources/10638 - Service IO - TEST");
